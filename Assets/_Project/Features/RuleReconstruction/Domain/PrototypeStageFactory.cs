...
namespace Expost.RuleReconstruction
{
    public static class PrototypeStageFactory
    {
        public static List<StageData> CreateStages()
        {
            ...
            {
                Create("01 Color Basics",
                    new[] { Source(1, 1, BoxColor.Red), Source(2, 2, BoxColor.Blue), Source(3, 3, BoxColor.Green) },
                ...
                Create("02 Direction Basics",
                    new[] { Source(1, 1, BoxColor.Red), Source(2, 2, BoxColor.Blue), Source(3, 3, BoxColor.Green) },
                    Answer(BoxColor.Red, DirectionType.Cross, RangeType.One),
                    Answer(BoxColor.Blue, DirectionType.Diagonal, RangeType.One),
                    Answer(BoxColor.Green, DirectionType.Horizontal, RangeType.One)),
                Create("03 Range Basics",
                    new[] { Source(1, 1, BoxColor.Red), Source(2, 2, BoxColor.Blue), Source(3, 3, BoxColor.Green) },
                    Answer(BoxColor.Red, DirectionType.Cross, RangeType.Two),
                    Answer(BoxColor.Blue, DirectionType.Diagonal, RangeType.One),
                    Answer(BoxColor.Green, DirectionType.Vertical, RangeType.Two)),
                Create("04 Effect Basics",
                    new[] { Source(1, 1, BoxColor.Red), Source(2, 2, BoxColor.Blue), Source(3, 3, BoxColor.Green) },
                    Answer(BoxColor.Red, DirectionType.Cross, RangeType.One),
                    Answer(BoxColor.Blue, DirectionType.Cross, RangeType.One, EffectType.SubtractNumber),
                    Answer(BoxColor.Green, DirectionType.Cross, RangeType.One)),
                Create("05 Four Color Split",
                    ...
                    Answer(BoxColor.Green, DirectionType.Diagonal, RangeType.Two, EffectType.SubtractNumber),
                    Answer(BoxColor.Yellow, DirectionType.Cross, RangeType.One)),
                Create("06 Diagonal Trap",
